$(function () {
    ...
    //已完成
    $('.stayorder li:nth-child(5)').on('click',function () {
        $('section').empty();
        $.ajax({
            type:"get",
