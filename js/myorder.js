            ...
            success:function (data) {
                ...
                for(let i=0;i<data.result.length;i++){
                    var status=data.result[i].status;
                     if(status=="2"){
                        $('<div class="payment"><div class="paymentBox"><div class="payment-store"><span>'+data.result[i].supplier[0].supplier_name+'</span><i>买家已付款</i></div></div> <div class="paymentRow"><div class="payment-row"><div class="paymentpic"><img src="'+data.result[i].supplier[0].list[0].goodimg+'" alt="" style="width: 1.74rem;height: 1.74rem;"></div><div class="payment-box"><div class="payment-inn">'+data.result[i].supplier[0].list[0].goodname+'</div><div class="payment-sku">'+data.result[i].supplier[0].list[0].sku+'</div><div class="payment-price"><div class="price-box"><div class="price">'+data.result[i].supplier[0].list[0].buyintegral+' 积分</div><div class="price-num">x<span>'+data.result[i].supplier[0].list[0].buynum+'</span></div></div></div></div> </div></div><div class="payment-allbox"><div class="payment-inall"><span>共计<span>'+data.result[i].supplier[0].buynum+'</span>件商品， 合计:  <i>'+data.result[i].totalprice.split('.')[0]+' 积分</i></span></div></div><div class="payment-footer"><a href="../html/seedetails.html?orderid='+data.result[i].orderid+'"><div class="sees">查看详情</div></a></div></div>').appendTo($('section'))
                    }else if(status=="3"){
                        $('<div class="payment"><div class="paymentBox"><div class="payment-store"><span>'+data.result[i].supplier[0].supplier_name+'</span><i>卖家已发货</i></div></div><div class="paymentRow"><div class="payment-row"><div class="paymentpic"><img src="'+data.result[i].supplier[0].list[0].goodimg+'" alt="" style="width: 1.74rem;height: 1.74rem;"></div><div class="payment-box"><div class="payment-inn">'+data.result[i].supplier[0].list[0].goodname+'</div><div class="payment-sku">'+data.result[i].supplier[0].list[0].sku+'</div> <div class="payment-price"><div class="price-box"><div class="price">'+data.result[i].supplier[0].list[0].buyintegral+' 积分</div><div class="price-num">x<span>'+data.result[i].supplier[0].list[0].buynum+'</span></div></div></div></div></div> </div><div class="payment-allbox"><div class="payment-inall"><span>共计<span>'+data.result[i].supplier[0].buynum+'</span>件商品， 合计:  <i>'+data.result[i].totalprice.split('.')[0]+' 积分</i></span></div></div><div class="payment-footer"><a href="../html/logistics.html?orderid='+data.result[i].orderid+'&shipno='+data.result[i].shipno+'" style="display: block"><div class="see">查看物流</div></a><div class="confirm allconfirm" confirm-id='+data.result[i].orderid+'>确认订单</div></div></div>').appendTo($('section'))
                    }else if(status=="100"){
                        console.log(data.result)
                        $('<div class="payment"><div class="paymentBox"><div class="payment-store"><span>'+data.result[i].supplier[0].supplier_name+'</span><i>交易成功</i></div></div><div class="paymentRow"><div class="payment-row"><div class="paymentpic"><img src="'+data.result[i].supplier[0].list[0].goodimg+'" alt="" style="width: 1.74rem;height: 1.74rem;"></div><div class="payment-box"><div class="payment-inn">'+data.result[i].supplier[0].list[0].goodname+'</div><div class="payment-sku">'+data.result[i].supplier[0].list[0].sku+'</div><div class="payment-price"><div class="price-box"><div class="price">'+data.result[i].supplier[0].list[0].buyintegral+' 积分</div><div class="price-num">x<span>'+data.result[i].supplier[0].list[0].buynum+'</span></div></div></div></div> </div></div><div class="payment-allbox"><div class="payment-inall"><span>共计<span>'+data.result[i].supplier[0].buynum+'</span>件商品， 合计:  <i>'+data.result[i].totalprice.split('.')[0]+' 积分</i></span></div></div><div class="payment-footer"><div class="see alldelete" delete-id='+data.result[i].orderid+'>删除订单</div></div></div>').appendTo($('section'))
                    }
                }
